...
write.csv(sig1,"HISEQ_SpinalCord_ALSCohort_NoGliaMarkers1k_NoRIN05_SexSigGenes_9-11-23.csv")
...
file = "HISEQ_SpinalCord_FULLCohort_VST_Gene_NoFiltering_TE_9-27-23.csv"
write.csv(filtdata,file)
file = "HISEQ_SpinalCord_FULLCohort_VST_Gene_NoFiltering_TE_9-27-23.txt"
...
# file = "HISEQ_SpinalCord_FULLCohort_ALS_MAD10k_GeneENSEMBL_NoFiltering_TE_9-11-23.txt"
# write.table(mad10000,file,sep="\t",quote=F,row.names=T,col.names=T)
# file = "HISEQ_SpinalCord_FULLCohort_ALS_MAD10k_GeneENSEMBL_NoFiltering_TE_9-11-23.csv"
...
for(i in 1:nrow(MAD10k)){
  for(j in 1:nrow(gene_positions)){
    if(DONE == F){
      if(rownames(MAD10k)[i] == gene_positions$ensembl_gene_id[j]){
...
file = "HISEQ_SpinalCord_FULLCohort_ALS_MAD10k_GeneSYMBOL_NoFiltering_TE_9-27-23.csv"
write.csv(MAD10k_SAKE,file)

save.image("HiSeq_MAD10k_Ready4Clustering_withControls_NoFiltering_9-27-23.RData")
#load("G:/SpinalCord/Publication/RawExpression/WithControls/HiSeq_NoOligo/HiSeq_MAD10k_Ready4Clustering_withControls_8-15-23.RData")
...
write.csv(NormCounts,"HiSeq_SpinalCord_withControls_MedianofRatios_ENSG_NoFiltering_9-27-23.csv")
