...
# which(rownames(FullHiSymbol) == "SLC17A6")
# which(Combined_gene_positions$hgnc_symbol == "SLC17A6")
...
##Remove platform-specific sex-dependent genes
#NOVASEQ
...
#Confirmed: Genes specific to a single sequencing platform were removed as sex-dependent, as determined by DESeq2
############################## 
...
filen2 = "SpinalCord_CombinedPlatform_NovaSeqSamples_Top1000_MoR.csv"
write.csv(CA1000N,filen2) 

filen2 = "SpinalCord_CombinedPlatform_HiSeqSamples_Top1000_MoR.csv"
write.csv(CA1000H,filen2) 

filen2 = "SpinalCord_CombinedPlatform_AllSamples_Top1000_MoR.csv"
write.csv(CA1000,filen2) 

#Full Feature Sets

# filen2 = "SpinalCord_CombinedPlatform_NovaSeqSamples_MoR_SYMBOL.csv"
# write.csv(FullNovaSymbol,filen2) 
# 
# filen2 = "SpinalCord_CombinedPlatform_HiSeqSamples_MoR_SYMBOL.csv"
...
#HISEQ
# MAD10k = FullHiSymbol
# h1 = which(! Ctop2500ALL2 %in% rownames(MAD10k))
...
filen2 = "SpinalCord_CombinedPlatform_NovaSeqSamples_Top2500_MoR.csv"
write.csv(CA2500N,filen2) 

filen2 = "SpinalCord_CombinedPlatform_HiSeqSamples_Top2500_MoR.csv"
write.csv(CA2500H,filen2) 

filen2 = "SpinalCord_CombinedPlatform_AllSamples_Top2500_MoR.csv"
...
filen2 = "SpinalCord_CombinedPlatform_NovaSeqSamples_Top5000_MoR.csv"
write.csv(CA5000N,filen2) 

filen2 = "SpinalCord_CombinedPlatform_HiSeqSamples_Top5000_MoR.csv"
write.csv(CA5000H,filen2) 

filen2 = "SpinalCord_CombinedPlatform_AllSamples_Top5000_MoR.csv"
...
writeLines(paste(PhenoLUT$Factor,sep="",collapse="\t"),"Pheno_4Covar_MoR.txt")
...
tmp2 = tmp[-removeind,]
write.csv(tmp2,"SpinalCord_CombinedPlatform_AllSamples_Top1000_MoR_NoTE_NoENSG_9-30-23.csv")
...
removeind = as.numeric(names(table(c(removeind1,removeind2))))
tmp2 = tmp[-removeind,]
write.csv(tmp2,"SpinalCord_CombinedPlatform_AllSamples_Top2500_MoR_NoTE_NoENSG_9-30-23.csv")
...
removeind = as.numeric(names(table(c(removeind1,removeind2))))
tmp2 = tmp[-removeind,]
write.csv(tmp2,"SpinalCord_CombinedPlatform_AllSamples_Top5000_MoR_NoTE_NoENSG_9-30-23.csv")