...
cortexprobs = c(98/ncort,35/ncort,63/ncort)
spinalprobs = c(46/nspinal,46/nspinal,63/nspinal)
...
pbinom(20,size=nrow(PatientPheno),prob=mean(FC_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(34,size=nrow(PatientPheno),prob=mean(FC_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(13,size=nrow(PatientPheno),prob=mean(FC_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(22,size=nrow(PatientPheno),prob=mean(FC_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(18,size=nrow(PatientPheno),prob=mean(FC_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(29,size=nrow(PatientPheno),prob=mean(FC_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(16,size=nrow(PatientPheno),prob=mean(MM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(26,size=nrow(PatientPheno),prob=mean(MM_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(12,size=nrow(PatientPheno),prob=mean(MM_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(21,size=nrow(PatientPheno),prob=mean(MM_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(16,size=nrow(PatientPheno),prob=mean(MM_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(23,size=nrow(PatientPheno),prob=mean(MM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(15,size=nrow(PatientPheno),prob=mean(LM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(14,size=nrow(PatientPheno),prob=mean(LM_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(19,size=nrow(PatientPheno),prob=mean(LM_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(12,size=nrow(PatientPheno),prob=mean(LM_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(29,size=nrow(PatientPheno),prob=mean(LM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(1,size=nrow(PatientPheno),prob=mean(UM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(5,size=nrow(PatientPheno),prob=mean(UM_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
pbinom(0,size=nrow(PatientPheno),prob=mean(UM_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(3,size=nrow(PatientPheno),prob=mean(UM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 

par(mfrow=c(1,1))

setwd("G:/SpinalCord/Publication/Concordance")
#save.image("Bootstrap_Concordance_10kiter_1-28-24_HiSeq_AccurateProbs.RData")
load("G:/SpinalCord/Publication/Concordance/Bootstrap_Concordance_10kiter_1-19-24_HiSeq.RData")
