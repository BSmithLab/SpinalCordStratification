...
#Missing pairings in the NovaSeq are causing issues with the discordant distribution

nboot = 10000
PatientPheno = read.csv("C:/Users/Jarrett Eshima/Documents/Research/Dissertation/Concordance/SpinalCord_Concordance_NovaSeq_9-18-23.csv")
...
cortexprobs = c(141/ncort,49/ncort,65/ncort)
spinalprobs = c(93/nspinal,60/nspinal,120/nspinal)
...
abline(v=50,col="red") #This is the actual number of concordant sample pairings
...
#pnorm(q=(50-mean(FC_Cervical_nConcordant))/sd(FC_Cervical_nConcordant) ,lower.tail = F)
pbinom(50,size=nrow(PatientPheno),prob=mean(FC_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
#pnorm(q=(66-mean(FC_Cervical_nDiscordant))/sd(FC_Cervical_nDiscordant) ,lower.tail = T)
pbinom(66,size=nrow(PatientPheno),prob=mean(FC_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=5,col="red")
#pnorm(q=(5-mean(FC_Thoracic_nConcordant))/sd(FC_Thoracic_nConcordant) ,lower.tail = F)
pbinom(5,size=nrow(PatientPheno),prob=mean(FC_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=13,col="red")
#pnorm(q=(13-mean(FC_Thoracic_nDiscordant))/sd(FC_Thoracic_nDiscordant) ,lower.tail = T)
pbinom(13,size=nrow(PatientPheno),prob=mean(FC_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=50,col="red")
#pnorm(q=(50-mean(FC_Lumbar_nConcordant))/sd(FC_Lumbar_nConcordant) ,lower.tail = F)
pbinom(50,size=nrow(PatientPheno),prob=mean(FC_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=62,col="red")
#pnorm(q=(62-mean(FC_Lumbar_nDiscordant))/sd(FC_Lumbar_nDiscordant) ,lower.tail = T)
pbinom(62,size=nrow(PatientPheno),prob=mean(FC_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=22,col="red")
#pnorm(q=(22-mean(MM_Cervical_nConcordant))/sd(MM_Cervical_nConcordant) ,lower.tail = F)
pbinom(22,size=nrow(PatientPheno),prob=mean(MM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=32,col="red")
#pnorm(q=(32-mean(MM_Cervical_nDiscordant))/sd(MM_Cervical_nDiscordant) ,lower.tail = T)
pbinom(32,size=nrow(PatientPheno),prob=mean(MM_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=6,col="red")
#pnorm(q=(6-mean(MM_Thoracic_nConcordant))/sd(MM_Thoracic_nConcordant) ,lower.tail = F)
pbinom(6,size=nrow(PatientPheno),prob=mean(MM_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=11,col="red")
#pnorm(q=(11-mean(MM_Thoracic_nDiscordant))/sd(MM_Thoracic_nDiscordant) ,lower.tail = T)
pbinom(11,size=nrow(PatientPheno),prob=mean(MM_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=22,col="red")
#pnorm(q=(22-mean(MM_Lumbar_nConcordant))/sd(MM_Lumbar_nConcordant) ,lower.tail = F)
pbinom(22,size=nrow(PatientPheno),prob=mean(MM_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=24,col="red")
#pnorm(q=(24-mean(MM_Lumbar_nDiscordant))/sd(MM_Lumbar_nDiscordant) ,lower.tail = T)
pbinom(24,size=nrow(PatientPheno),prob=mean(MM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=18,col="red")
#pnorm(q=(18-mean(LM_Cervical_nConcordant))/sd(LM_Cervical_nConcordant) ,lower.tail = F)
pbinom(18,size=nrow(PatientPheno),prob=mean(LM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
pbinom(30,size=nrow(PatientPheno),prob=mean(LM_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=5,col="red")
#pnorm(q=(5-mean(LM_Thoracic_nConcordant))/sd(LM_Thoracic_nConcordant) ,lower.tail = F)
pbinom(5,size=nrow(PatientPheno),prob=mean(LM_Thoracic_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=10,col="red")
#pnorm(q=(10-mean(LM_Thoracic_nDiscordant))/sd(LM_Thoracic_nDiscordant) ,lower.tail = T)
pbinom(10,size=nrow(PatientPheno),prob=mean(LM_Thoracic_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=21,col="red")
#pnorm(q=(21-mean(LM_Lumbar_nConcordant))/sd(LM_Lumbar_nConcordant) ,lower.tail = F)
pbinom(21,size=nrow(PatientPheno),prob=mean(LM_Lumbar_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=22,col="red")
#pnorm(q=(22-mean(LM_Lumbar_nDiscordant))/sd(LM_Lumbar_nDiscordant) ,lower.tail = T)
pbinom(22,size=nrow(PatientPheno),prob=mean(LM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 
...
abline(v=20,col="red")
#pnorm(q=(20-mean(UM_Cervical_nConcordant))/sd(UM_Cervical_nConcordant) ,lower.tail = F)
pbinom(20,size=nrow(PatientPheno),prob=mean(UM_Cervical_nConcordant)/nrow(PatientPheno),lower.tail = F) 
...
abline(v=22,col="red")
#pnorm(q=(22-mean(UM_Cervical_nDiscordant))/sd(UM_Cervical_nDiscordant) ,lower.tail = T)
pbinom(22,size=nrow(PatientPheno),prob=mean(UM_Cervical_nDiscordant)/nrow(PatientPheno),lower.tail = T) 

# hist(UM_Thoracic_nConcordant,main="Unspecified Motor Cortex vs Thoracic Spinal",breaks = length(seq(min(UM_Thoracic_nConcordant),max(UM_Thoracic_nConcordant))))
# abline(v=0,col="red")
...
# hist(UM_Thoracic_nDiscordant,main="Unspecified Motor Cortex vs Thoracic Spinal",breaks = length(seq(min(UM_Thoracic_nDiscordant),max(UM_Thoracic_nDiscordant))))
# abline(v=0,col="red")
# pnorm(q=(0-mean(UM_Thoracic_nDiscordant))/sd(UM_Thoracic_nDiscordant) ,lower.tail = T)
...
abline(v=18,col="red")
#pnorm(q=(18-mean(UM_Lumbar_nDiscordant))/sd(UM_Lumbar_nDiscordant) ,lower.tail = T)
pbinom(18,size=nrow(PatientPheno),prob=mean(UM_Lumbar_nDiscordant)/nrow(PatientPheno),lower.tail = T) 

par(mfrow=c(1,1))

setwd("G:/SpinalCord/Publication/Concordance")
#save.image("Bootstrap_Concordance_10kiter_1-28-24_NovaSeq_AccurateProbs.RData")
load("G:/SpinalCord/Publication/Concordance/Bootstrap_Concordance_10kiter_1-28-24_NovaSeq_AccurateProbs.RData")
