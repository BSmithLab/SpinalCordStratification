...
setwd(wd)
Pheno = read.csv("Supplemental_Dataset2.csv")
...
Expr = read.csv("G:/SpinalCord/Publication/FinalEnrichment/SpinalCord_CombinedPlatform_AllSamples_Top1000_MoR_NoTE_NoENSG_9-30-23.csv") #Files found at: https://figshare.com/authors/Jarrett_Eshima/13813720
