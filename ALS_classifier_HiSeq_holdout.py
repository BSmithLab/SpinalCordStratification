# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 12:39:04 2023

@author: trpen
"""

## Part 3) Train on novaseq data, validate on hiseq data
...
###############################################################################
##Cortex, capitalize 'platform' in csv file
...
plt.savefig("f1_pt3_Nova_Hi-600dpi.svg", format='svg', dpi = 600, bbox_inches = 'tight')
plt.savefig("f1_pt3_Nova_Hi-300dpi.svg", format='svg', dpi = 300, bbox_inches = 'tight')
plt.show()
...
# ROC curves from all classifiers on same plot
